insert into patient values('asdf1', 1, 1 ,2, now(), 4, 1, 2);
insert into patient values('asdf2', 1, 2 ,5, now(), 4, 1, 4);
insert into patient values('asdf3', 2, 3 ,6, now(), 4, 1, 4);
insert into patient values('asdf4', 2, 4 ,7, now(), 4, 1, 5);
insert into patient values('asdf5', 1, 5 ,8, now(), 4, 1, 3);
insert into patient values('asdf6', 1, 6 ,9, now(), 4, 2, 5);
insert into patient values('asdf7', 1, 7 ,10, now(), 3, 2, 5);
insert into patient values('asdf8', 1, 8 ,11, now(), 3, 2, 3);
